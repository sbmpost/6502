...
#include "VLogisimTickGenerator.h" // From Verilating "LogisimToplevelShell.v"
#if VM_TRACE
# include <verilated_vcd_c.h>	   // Trace file format header
#endif

VLogisimTickGenerator *logisim;			// Instantiation of module
...
int main(int argc, char **argv, char **env) {
    ...
    logisim = new VLogisimTickGenerator;		// Create instance of module
...
*/
	VL_PRINTF ("[%" VL_PRI64 "d] clk: %x tick: %x\n", // _%08x_%08x\n",
          main_time,
          logisim->FPGAClock,
          logisim->FPGATick
        );
